...
namespace Proxies\__CG__\Aurelio\AgendaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Reuniao extends \Aurelio\AgendaBundle\Entity\Reuniao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'id', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'nome', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'descricao', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'local', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'status', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'pessoas', '' . "\0" . 'Aurelio\\AgendaBundle\\Entity\\Reuniao' . "\0" . 'datas'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reuniao $proxy) {
    ...
    public function getPessoas()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPessoas', []);

        return parent::getPessoas();
    }
