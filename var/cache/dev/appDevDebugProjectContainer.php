...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' => 'get1A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService',
            '2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' => 'get2A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService',
        ...
        $this->privates = array(
            '1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' => true,
            '2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c']) ? $this->services['1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c'] : $this->get1A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c']) ? $this->services['2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c'] : $this->get2A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'agenda_sy', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\Aurelio\\AgendaBundle\\Entity'))), 'Aurelio\\AgendaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AurelioAgendaBundle' => 'Aurelio\\AgendaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fbe2380e13d3692b3a43ddcfea669228ae5d258e5be250c41c7143a0d8f147e9');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->get('twig.loader')) && false ?: '_'}, array('form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Aurelio\\AgendaBundle/Resources/views'), 'AurelioAgenda');
    ...
    /**
     * Gets the private '1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService()
    {
        return $this->services['1_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2A3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899cService()
    {
        return $this->services['2_a3a3bf2ee95131cc943f7dae3a42ed2e4ef5ae9d697d99dc7355a47d13c3899c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('c866f62Hr0', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lhlfN52z6N', 0, 'JHTR7NBNdxvDdQF0cHEt9Q', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zr+kVbFaNT', 0, 'JHTR7NBNdxvDdQF0cHEt9Q', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vLK3bqOULn', 0, 'JHTR7NBNdxvDdQF0cHEt9Q', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59b96c49a80797.25784606');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AurelioAgendaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Aurelio\\AgendaBundle'),
                    'namespace' => 'Aurelio\\AgendaBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AurelioAgendaBundle' => 'Aurelio\\AgendaBundle\\AurelioAgendaBundle',
